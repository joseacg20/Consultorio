                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn waves-effect red" >
                                    <a href="{{ route('secretarias.edit', $secretary->id) }}" role="button" style="color:green; text-decoration:none">Actualizar</a>
                                </button>
                            </td> 
                            <td>
                                <button class="btn waves-effect red" >
                                    <a href="{{ route('secretarias.show', $secretary->id) }}" role="button" style="text-decoration:none">Ver</a>
                                </button>
                            </td> 
                            <td> 
                                <!-- Button trigger modal -->
                                <button class="btn waves-effect red" data-toggle="modal" style="color:red" data-target="#eliminar-{{ $secretary->id }}">Eliminar</button>
                                
                                <!-- Modal -->
                                <div class="modal fade" id="eliminar-{{ $secretary->id }}" tabindex="-1" role="dialog" aria-labelledby="eliminarTitle" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form method="POST" action="{{ route('secretarias.destroy', $secretary->id) }}" accept-charset="UTF-8">
                                                    @csrf
                                                    @method('delete')
